...
exports.register = function (server, options, next) {
    ...
    server.on('start', function () {
        ...
        for (var i = 0, il = connections.length; i < il; ++i) {
            ...
            routesToShow = internals.toShow(connection.table, routesToShow);
        }

        internals.print(routesToShow);
    });
...
internals.toShow = function (routes, toShow) {
...
internals.print = function (routes) {
